...
- Generate an app key: to have your own API key in your newly created .env file run this command ```php artisan key:generate```

- Now to actually make the database, you can make the SQLite file with the following command (Mac): ```touch database/database.sqlite```
